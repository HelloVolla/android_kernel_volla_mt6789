                ...
                const char *buf, size_t size)
{
	...
	{
		aw36518_set_level(AW36518_CHANNEL_CH1, 2);
	
		if (aw36518_timeout_ms[AW36518_CHANNEL_CH1]) {
			ktime =
			ktime_set(aw36518_timeout_ms[AW36518_CHANNEL_CH1] / 1000,
...
static DEVICE_ATTR(irtouch_value, S_IRUGO|S_IWUSR|S_IWGRP, device_irtouch_value_show, device_irtouch_value_store);

static ssize_t device_touch_value_show(struct device *dev,
                struct device_attribute *attr,
                char *buf)
{
	printk("aw36518 cur_irtouch_status=%d\n", cur_irtouch_status);
...
static ssize_t device_touch_value_store(struct device *dev,
                struct device_attribute *attr,
                const char *buf, size_t size)
{
	ktime_t ktime;
...
static DEVICE_ATTR(touch_value, S_IRUGO|S_IWUSR|S_IWGRP, device_touch_value_show, device_touch_value_store);
