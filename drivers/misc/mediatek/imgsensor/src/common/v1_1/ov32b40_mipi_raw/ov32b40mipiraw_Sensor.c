...
#include "ov32b40mipiraw_Sensor.h"

#ifdef CONFIG_MTK_CAM_CAL
extern int read_ov32b40_eeprom_mtk_fmt(void);
#endif


/****************************Modify following Strings for debug****************************/
#define PFX "ov32b40_camera_sensor"
#define LOG_1 LOG_INF("ov32b40,MIPI 2LANE\n")
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV32B40_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
	...
	.ae_sensor_gain_delay_frame = 0, //drv add by lipengpeng 20230704 
	.ae_ispGain_delay_frame = 2,//isp gain delay frame for AE cycle
	.frame_time_delay_frame = 1,	//drv add by lipengpeng 20230704 
...
static struct imgsensor_struct imgsensor = {
	...
	.shutter = 0xB00,					/*current shutter*/ //drv add by lipengpeng 20230704 
...
#endif
/*
#define OV32B40MIPI_MaxGainIndex (97)
kal_uint16 OV32B40MIPI_sensorGainMapping[OV32B40MIPI_MaxGainIndex][2] ={
{ 64 ,0  },
{ 68 ,12 },
{ 71 ,23 },
{ 74 ,33 },
...
static void write_shutter(kal_uint32 shutter)
{
	...
	write_cmos_sensor(0x380f, imgsensor.frame_length & 0xFF);
	write_cmos_sensor(0x3500,(shutter >> 16)); 
...
//prize add by lipengpeng 20200722 start
 #define MJY_MODULE_ID_OFFSET  0x0001
static kal_uint16 read_module_id_mjy(void)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(MJY_MODULE_ID_OFFSET >> 8), (char)(MJY_MODULE_ID_OFFSET & 0xFF)};
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	printk("111LPP,read_module_id_mjy=%x",read_module_id_mjy());
...
UINT32 OV32B40_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
...
EXPORT_SYMBOL(OV32B40_MIPI_RAW_SensorInit);
