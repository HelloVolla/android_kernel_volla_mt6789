...
void apply_4h7_otp_awb(void)
{
	...
	otp_4h7_data_info.ngcur = (unsigned int)((otp_4h7_data_info.ngrcur + otp_4h7_data_info.ngbcur)*1000/2 + 500);

	otp_4h7_data_info.frgcur = (unsigned int)(otp_4h7_data_info.nrcur*1000 / otp_4h7_data_info.ngcur + 500);
	otp_4h7_data_info.fbgcur = (unsigned int)(otp_4h7_data_info.nbcur*1000 / otp_4h7_data_info.ngcur + 500);

	otp_4h7_data_info.nggolden = (unsigned int)((otp_4h7_data_info.ngrgolden + otp_4h7_data_info.ngbgolden)*1000 / 2 + 500);

	otp_4h7_data_info.frggolden = (unsigned int)(otp_4h7_data_info.nrgolden*1000 / otp_4h7_data_info.nggolden + 500);
	otp_4h7_data_info.fbggolden = (unsigned int)(otp_4h7_data_info.nbgolden*1000 / otp_4h7_data_info.nggolden + 500);


	r_ratio = (unsigned int)((otp_4h7_data_info.frggolden * 1000 / otp_4h7_data_info.frgcur + 500)/1000);
	b_ratio = (unsigned int)((otp_4h7_data_info.fbggolden * 1000 / otp_4h7_data_info.fbgcur + 500)/1000);

	cal_4h7_rgb_gain(&otp_4h7_data_info.nr_gain, &otp_4h7_data_info.ng_gain, &otp_4h7_data_info.nb_gain, r_ratio, b_ratio);

	r_gain_h = (otp_4h7_data_info.nr_gain >> 8) & 0xff;
	r_gain_l = (otp_4h7_data_info.nr_gain >> 0) & 0xff;

	g_gain_h = (otp_4h7_data_info.ng_gain >> 8) & 0xff;
	g_gain_l = (otp_4h7_data_info.ng_gain >> 0) & 0xff;

	b_gain_h = (otp_4h7_data_info.nb_gain >> 8) & 0xff;
	b_gain_l = (otp_4h7_data_info.nb_gain >> 0) & 0xff;
...
int otp_group_info_4h7(void)
{
	...
	if (otp_4h7_data_info.lsc_infoflag == 0x01) {
		...
		otp_4h7_data_info.lsc_sum = selective_4h7_read_region_16(S5K4H7SUB_AWB_PAGE, 0x0A34);
	} else {
	...
	otp_4h7_data_info.nrcur = selective_4h7_read_region_16(S5K4H7SUB_AWB_PAGE, 0x0A0E);
	otp_4h7_data_info.nbcur = selective_4h7_read_region_16(S5K4H7SUB_AWB_PAGE, 0x0A10);
	otp_4h7_data_info.ngrcur = selective_4h7_read_region_16(S5K4H7SUB_AWB_PAGE, 0x0A12);
	otp_4h7_data_info.ngbcur = selective_4h7_read_region_16(S5K4H7SUB_AWB_PAGE, 0x0A14);

	otp_4h7_data_info.nrgolden = selective_4h7_read_region_16(S5K4H7SUB_AWB_PAGE, 0x0A16);
	otp_4h7_data_info.nbgolden = selective_4h7_read_region_16(S5K4H7SUB_AWB_PAGE, 0x0A18);
	otp_4h7_data_info.ngrgolden = selective_4h7_read_region_16(S5K4H7SUB_AWB_PAGE, 0x0A1A);
	otp_4h7_data_info.ngbgolden = selective_4h7_read_region_16(S5K4H7SUB_AWB_PAGE, 0x0A1c);

	if ((otp_4h7_data_info.infoflag>>4 & 0x0c) == 0x04) {
		otp_4h7_data_info.awb_offset = 0;
		otp_4h7_data_info.group = 1;
		otp_4h7_data_info.awb_flag_sum = selective_4h7_read_region_16(S5K4H7SUB_AWB_PAGE, 0x0A2E);
	} else if ((otp_4h7_data_info.infoflag>>4 & 0x03) == 0x01) {
		otp_4h7_data_info.awb_offset = 0X10;
		otp_4h7_data_info.group = 2;
		otp_4h7_data_info.awb_flag_sum = selective_4h7_read_region_16(S5K4H7SUB_AWB_PAGE, 0x0A30);
	} else {
...
bool check_4h7_sum_flag_awb(void)
{
	...
	if (otp_4h7_data_info.group == 1) {
		sum_awbfg = sum_4h7_awb_flag_lsc(0x0A05, 0X0A08, data_p[page_start-1]);
		sum_awbfg += sum_4h7_awb_flag_lsc(0x0A0E, 0X0A1D, data_p[page_start-1]);
	} else if (otp_4h7_data_info.group == 2) {
		sum_awbfg = sum_4h7_awb_flag_lsc(0x0A09, 0X0A0C, data_p[page_start-1]);
		sum_awbfg += sum_4h7_awb_flag_lsc(0x0A1E, 0X0A2D, data_p[page_start-1]);
	}
	if (sum_awbfg == otp_4h7_data_info.awb_flag_sum) {
		apply_4h7_otp_awb();
	} else {
