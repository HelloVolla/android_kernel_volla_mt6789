...
#include "s5khm2spylmipiraw_Sensor.h"
#include "s5khm2spyl_sensor_setting.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KHM2SPYL_SENSOR_ID, //Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
	.checksum_value = 0x25cdd88, /* checksum value for Camera Auto Test */
	.pre = {
		.pclk = 1600000000, /* record different mode's pclk */
		.linelength = 11088, /* record different mode's linelength */
		.framelength = 4810, /* record different mode's framelength */
		.startx = 0,
		...
		.max_framerate = 300,
		.mipi_pixel_rate = 762960000,
	},
	.cap = {
		.pclk = 1600000000, /* record different mode's pclk */
		.linelength = 16632, /* record different mode's linelength */
		.framelength = 9620, /* record different mode's framelength */
		.startx = 0,
		.starty = 0,   /* record different mode's starty of grabwindow */
	...
	.i2c_speed = 1000,
	.i2c_addr_table = {0x20, 0x5A, 0x7A, 0xff}, //record sensor support all write id addr, only supprt 4must end with 0xff
};
...
0x6028,0x2000,    ////Global,Analog setting 	
0x602A,0x2AC8,
0x6F12,0x001E,
0x602A,0x2ACE,
0x6F12,0x000D,
...
UINT32 S5KHM2SPYL_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
