...
static int gt9778_init(void)
{
	int i4RetValue = 0;
	char puSendCmd[3];
   
	printk("[GT9778AF] gt9778_init - beg\n");
	puSendCmd[0] = 0x02;
	puSendCmd[1] = 0x02;
	g_pstAF_I2Cclient->addr = AF_I2C_SLAVE_ADDR;
	g_pstAF_I2Cclient->addr = g_pstAF_I2Cclient->addr >> 1;
	...
	if (i4RetValue < 0)
	{
	   printk("bu6429 101 [GT9778AF] I2C send failed!! \n");
	}
	mdelay(5);
	puSendCmd[0] = 0x06;
	...
	if (i4RetValue < 0)
	{
	   printk("bu6429 109 [GT9778AF] I2C send failed!! \n");
	}
	puSendCmd[0] = 0x07;
	...
	if (i4RetValue < 0)
	{
	   printk("bu6429 116 [GT9778AF] I2C send failed!! \n");
	}
	...
	LOG_INF("[GT9778AF] GT9778AF SRC Init End!! \n");
