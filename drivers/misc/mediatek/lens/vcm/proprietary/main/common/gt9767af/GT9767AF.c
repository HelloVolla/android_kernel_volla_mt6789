...
/*
 * GT9767AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "GT9767AF_DRV"
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	g_u4LastPosition = g_u4TargetPosition;
...
/* ////////////////////////////////////////////////////////////// */
long GT9767AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int GT9767AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	printk("Start\n");
	...
	if (*g_pAF_Opened == 2) {
		...
		msleep(20);
		#endif
//		LOG_INF("g_u4LastPostion: %d, AFInf_u4CurrPosition: %d\n", g_u4LastPosition, AFInf_u4CurrPosition);
...
int GT9767AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
...
int GT9767AF_GetFileName(unsigned char *pFileName)
{
...
int GT9767AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
	g_pstAF_I2Cclient = pstAF_I2Cclient;
	g_pAF_Opened = pAF_Opened;
