...
lcm_dcs_write_seq_static(ctx,0x19, 0xB9);
...
lcm_dcs_write_seq_static(ctx,0xE0, 0x00,0xA0,0x78,0xAD,0xEF,0x55,0x23,0x4B,0x7B,0xA1,0xA9,0xDE,0x10,0x3D,0x67,0xEA,0x93,0xC6,0xE5,0x0B,0xFF,0x2C,0x55,0x86,0xB3,0x03,0xEC);							
...
lcm_dcs_write_seq_static(ctx,0x00,0x40);
...
lcm_dcs_write_seq_static(ctx,0x46,0x06);
...
lcm_dcs_write_seq_static(ctx,0x4E,0x2B);
lcm_dcs_write_seq_static(ctx,0x4F,0x2A);
lcm_dcs_write_seq_static(ctx,0x50,0x14);
lcm_dcs_write_seq_static(ctx,0x51,0x13);
lcm_dcs_write_seq_static(ctx,0x52,0x12);
lcm_dcs_write_seq_static(ctx,0x53,0x11);
lcm_dcs_write_seq_static(ctx,0x54,0x10);
lcm_dcs_write_seq_static(ctx,0x55,0x08);
...
lcm_dcs_write_seq_static(ctx,0x75,0x06);
...
lcm_dcs_write_seq_static(ctx,0xd0,0x01);
lcm_dcs_write_seq_static(ctx,0xd1,0x12);
...
lcm_dcs_write_seq_static(ctx,0xda,0x80);
lcm_dcs_write_seq_static(ctx,0xdc,0x10);
lcm_dcs_write_seq_static(ctx,0xdd,0x40);
lcm_dcs_write_seq_static(ctx,0xdf,0xb6);
lcm_dcs_write_seq_static(ctx,0xe2,0x75);
lcm_dcs_write_seq_static(ctx,0xe6,0x22);
lcm_dcs_write_seq_static(ctx,0xe7,0x54);
lcm_dcs_write_seq_static(ctx,0xFF,0x98,0x82,0x02);
...
lcm_dcs_write_seq_static(ctx,0x64,0x9C);
lcm_dcs_write_seq_static(ctx,0x68,0x29);
lcm_dcs_write_seq_static(ctx,0x69,0x2F);
lcm_dcs_write_seq_static(ctx,0x6A,0x3D);
lcm_dcs_write_seq_static(ctx,0x6B,0x2F);
...
lcm_dcs_write_seq_static(ctx,0xFF,0x98,0x82,0x08);
lcm_dcs_write_seq_static(ctx,0xE0,0x40,0x24,0xAE,0xE9,0x2C,0x55,0x5E,0x85,0xB2,0xD5,0xAA,0x0B,0x35,0x5B,0x80,0xEA,0xA6,0xD4,0xF0,0x14,0xFF,0x31,0x57,0x85,0xAB,0x03,0xEC);
lcm_dcs_write_seq_static(ctx,0xE1,0x40,0x24,0xAE,0xE9,0x2C,0x55,0x5E,0x85,0xB2,0xD5,0xAA,0x0B,0x35,0x5B,0x80,0xEA,0xA6,0xD4,0xF0,0x14,0xFF,0x31,0x57,0x85,0xAB,0x03,0xEC);
lcm_dcs_write_seq_static(ctx,0xFF,0x98,0x82,0x0B);
lcm_dcs_write_seq_static(ctx,0x9A,0x44);
lcm_dcs_write_seq_static(ctx,0x9B,0x84);
lcm_dcs_write_seq_static(ctx,0x9C,0x03);
lcm_dcs_write_seq_static(ctx,0x9D,0x03);
...
static struct drm_display_mode default_mode = {
	.clock = 84972,//htotal*vtotal*vrefresh/1000   163943   182495
	.hdisplay = HAC,
	.hsync_start = HAC + HFP,
