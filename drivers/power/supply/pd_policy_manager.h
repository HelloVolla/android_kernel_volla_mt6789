...
extern int usbpd_pm_init(void);
extern int usbpd_pm_schedule(void);
extern int usbpd_get_hrst_cnt(void);
//extern void usbpd_set_hrst_cnt(void);
extern int usbpd_get_err_cnt(void);
