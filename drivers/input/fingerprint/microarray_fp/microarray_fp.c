...
/* prize added by chenjiaxi, microarray fingerprint info, 20210611-start */
#if defined(CONFIG_PRIZE_HARDWARE_INFO)
#include "../../../misc/mediatek/prize/hardware_info/hardware_info.h"
extern struct hardware_info current_fingerprint_info;
#endif
/* prize added by chenjiaxi, microarray fingerprint info, 20210611-end */
...
{	
	...
	MICROARRAY_FP_DEBUG("read id v2.5============\n");
...
/* prize added by chenjiaxi, microarray fingerprint info, 20210611-start */
#if defined(CONFIG_PRIZE_HARDWARE_INFO)
        sprintf(current_fingerprint_info.chip,"E064N");
