...
struct fts_ts_data {
    ...
    struct pinctrl *prize_pinctrl;
	struct pinctrl_state *pins_i2c_data;
    struct pinctrl_state *pins_i2c_data_gpio;
    struct pinctrl_state *pins_i2c_clk;
    struct pinctrl_state *pins_i2c_clk_gpio;
};
